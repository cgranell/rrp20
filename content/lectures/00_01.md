...
- Have you ever heard the term __reproducibility__?
...
- Session 04: RRP - Writing and dissemination
- Session 05: RRP - Publication and archiving
...
This course is much more about __learning to learn__ and __common sense__ rather than acquiring specific programming tricks and magical recipes

- Learn to __ask__ questions 
- __Help__ others as much as you can (the best way to learn is to teach)
- __Read__ additional materials
- __Practice__, __practice__ and __practice__ on your own research projects
...
- Come to class. _Thanks_
- Bring questions, comments, feedback, etc.
- Collaborate (it's a win-win instead of a zero-sum situation!)
- Last session: final project 
